...
// DecalDebugUI ships its own styles; without this the editor renders unstyled.
import '@tresjs/cientos/styles.css'

// Replica of the cientos Decal demo: logos stamped onto a mug, conforming to
// its curved surface. Decals stack with z-layering and the in-canvas
// DecalDebugUI lets you place/rotate/scale them with undo-redo.
...
// The GLTF group holds several meshes; the densest one is the mug body that
// the Decal projects onto.
  ...
  mug: [
    {
      ...
      position: [-0.8954501666345478, 2.045293983841609, 0.42795255054918213],
      orientation: [0, -1.1292619472765466, 0.007132597282973663],
      size: [0.89432140295958, 0.20421512351045526, 1],
      zIndex: 0,
      map: 'tresjs-dark.png',
    },
    {
      id: '61ce9dd7-e821-4445-9e82-b23a132a5b65',
      position: [0.44907470640757663, 1.8774883416773522, 0.8854636656395165],
      orientation: [0, 0.44153437951835, -0.18955754747596165],
      size: [0.6882457276077091, 0.6882457276077091, 1],
      zIndex: 1,
      map: 'vue.png',
    },
    {
      id: '953475fc-1864-466d-9bc9-2a0371a2903a',
      position: [-0.28197464991032084, 2.2293687089996417, -0.9524137096313172],
      orientation: [-3.141592653589793, -0.24455009528111096, -2.872728117206046],
      size: [0.6212901676939242, 0.6212901676939242, 1],
      zIndex: 2,
      map: 'threejs.png',
    },
  ],
