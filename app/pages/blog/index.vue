...
<template>
  <div
    class="overflow-x-hidden grid min-h-[calc(100vh-var(--ui-header-height))] grid-cols-1 grid-rows-[1fr_1px_auto_1px_auto] justify-center [--gutter-width:2.5rem] lg:grid-cols-[var(--gutter-width)_minmax(0,var(--ui-container))_var(--gutter-width)]"
  >
    ...
    <div class="row-start-1">
      ...
      <div class="relative before:absolute before:top-0 before:h-px before:w-[200vw] before:border-t before:border-dashed before:border-gray-200 dark:before:border-default before:-left-[100vw]">
        <div class="flex gap-8 justify-between items-stretch">
          ...
          <div class="w-full h-full border-l border-solid border-gray-200 dark:border-default">
            <div
              ref="blogPosts"
              class="relative px-4 pt-8 mx-auto blog-gradient-after"
